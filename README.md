...
Simply you can fork the code as your initial start. You can increase the number on inputs as needed by editing the index.html file, change colors of the app by editing the style.css file and adding more functionalities by adding more functions to the script.js file.
